...
\begin{minipage}{0.4\linewidth}
\posterfig{\linewidth}{tikz-radar-lib/inisar_pipeline_strip_vertical.pdf}{Six-stage 3D reconstruction pipeline}
\end{minipage}
\hfill
\begin{minipage}{0.56\linewidth}
  \textbf{Key Equations:}
...
\block{\textcolor{white}{\large \ding{208}\ \ Multipath Removal}}{
    \begin{minipage}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{other_range_doppler_profile_0.png}
        \small\textcolor{radarGrey}{Prior removal: noise and ghost targets}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{fig_radar_vs_camera_candidate0.png}
