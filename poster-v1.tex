...
\begin{minipage}{\linewidth}
\textbf{Why Not Just Use a Camera?}
...
% \begin{minipage}{0.48\linewidth}
% \textbf{3a. Radar Imaging Quality}\\[1.62mm]
...
% \posterfig{0.95\linewidth}{tikz-radar-lib/problem_panel_strip.pdf}{Indoor multipath generates ghost clusters}
% \end{minipage}
% \hfill
% \begin{minipage}{0.48\linewidth}
% \textbf{3b. Data Scarcity}\\[1.62mm]
...
% \end{minipage}
% }
\block{\textcolor{white}{\large \ding{203}\ \ Two Challenge in Radar-Based PID}}{
\begin{minipage}{\linewidth}
\textbf{3a. Radar Imaging Quality}\\[1.62mm]
\posterfig{\linewidth}{tikz-radar-lib/problem_panel_strip.pdf}
Conventional angle-of-arrival processing yields sparse, noisy point clouds: limited angular
resolution, motion-induced defocusing, multipath ghost artifacts (especially indoors).
InISAR has been validated on large \emph{rigid} targets (ships, aircraft) but not on small,
\emph{articulated} human targets.
...
\begin{minipage}{\linewidth}
\textbf{3b. Data Scarcity}\\[1.62mm]
\posterfig{\linewidth}{fig_few_shot_motivation.png}{A model trained on Task 1 subjects performs near-random on unseen Task 2 subjects}
Existing learning methods need $>$100 sequences/person (hours of recording) --
impractical for adapting to new individuals. PointNet is permutation-invariant but ignores local
geometry; PCT captures local structure but targets \emph{static} objects, not temporally
evolving, noisy radar sequences.
...
\block{\textcolor{white}{\large \ding{205}\ \ Key Results}}{
    \begin{center}
    \begin{tikzpicture}
...
\block{\textcolor{white}{\large \ding{206}\ \ Our Framework: Unified Sensing + Meta-Learning}}{
\posterfig{0.92\linewidth}{01_system_architecture.png}{End-to-end system: radar signal $\to$ InISAR 3D reconstruction $\to$ spatio-temporal learning $\to$ identity}
...
%   \posterfig{\linewidth}{tikz-radar-lib/inisar_pipeline_strip.pdf}{Six-stage 3D reconstruction pipeline}
...
% %   \hfill
% %   \begin{minipage}{0.48\linewidth}
% %     \posterfig{\linewidth}{fig_motion_compensation.png}{Range-FFT $\to$ ISAR Motion Compensation}
% %   \end{minipage}

% %   \vspace{2.91mm}
% %   \begin{minipage}{0.48\linewidth}
% %     \posterfig{\linewidth}{fig_cfar_pipeline.png}{Doppler-FFT $\to$ CFAR $\to$ Interferometry $\to$ Multi-Traget Tracking}
% %   \end{minipage}
% %   \hfill
% %   \begin{minipage}{0.48\linewidth}
...
% SECTION 5 -- DEEP DIVE (two sub-columns: InISAR | Learning)
% ============================================================
\block{\textcolor{white}{\large \ding{207}\ \ InISAR Pipeline}}{
\begin{minipage}{0.4\linewidth}
...
\block{\textcolor{white}{\large \ding{208}\ \ Multipath Removal}}{
    \begin{minipage}{0.48\linewidth}
        \centering
...
\block{\textcolor{white}{\large \ding{209}\ \ Validation: InISAR vs MoCap}}{
    \begin{minipage}{0.48\linewidth}
        \centering
